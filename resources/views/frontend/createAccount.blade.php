...
<section>
  ...
  <label id="register-terms-row">
    ...
    <span>Accept all <a href="#">terms &amp; Conditions</a></span>
  </label>
  ...
  <!-- Login link -->
  <p id="register-login-row">Already have account? <a href="signin.html">Login</a></p>
...
<script src="./assets/js/CreatAccount.js"></script>
</body>
</html>