...
<section>
  ...
  <div class="pd-gallery">
    <div class="pd-thumbs" id="thumbs">
      <div class="pd-thumb active"><img src="./assets/image/Product Image (1).png" alt=""></div>
      <div class="pd-thumb"><img src="./assets/image/chechout (1).png" alt=""></div>
      <div class="pd-thumb"><img src="./assets/image/chechout (2).png" alt=""></div>
      <div class="pd-thumb"><img src="./assets/image/chechout (3).png" alt=""></div>
    </div>
    <div class="pd-main-img-wrap">
      <img id="mainImg" src="./assets/image/Product Image (1).png" alt="Chinese Cabbage">
    </div>
  </div>
